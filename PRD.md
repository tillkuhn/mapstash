...
| REQ-015 | Create github action triggered by tags that start with the letter "v" and builds a docker image using Dockerfile.native, and pushes it to the repositories ghcr.io registry location                                                                                 | ✅ Implemented (commit: TBD) |
